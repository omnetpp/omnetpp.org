...
tabs:
- id: linux
  download-file-url: https://ipfs.omnetpp.org/release/4.6/omnetpp-4.6-src.tgz
  ipfs: ipfs get /ipns/ipfs.omnetpp.org/release/4.6/omnetpp-4.6-src.tgz

- id: windows
  download-file-url: https://ipfs.omnetpp.org/release/4.6/omnetpp-4.6-src-windows.zip
